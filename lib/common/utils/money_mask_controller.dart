...
class MoneyMaskedTextController extends TextEditingController {
  MoneyMaskedTextController({double initialValue = 0.0, this.decimalSeparator = ',', this.thousandSeparator = '.', this.suffix = '', this.prefix = '', this.precision = 2}) {
    _validateConfig();
  ...
  _validateConfig() {
    ...
    if (rightSymbolHasNumbers) {
      throw ArgumentError("não deve ter números.");
    }
  }
