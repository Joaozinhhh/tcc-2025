...
import 'package:src/common/constants/mutations/add_new_transaction.dart';
import 'package:src/common/constants/mutations/update_transaction.dart';
import 'package:src/common/constants/queries/get_all_transactions.dart';
import 'package:src/common/constants/queries/get_balances.dart';
import 'package:src/common/models/balances_model.dart';
import 'package:src/common/models/transaction_model.dart';
import 'package:src/locator.dart';
import 'package:src/services/graphql_service.dart';

abstract class TransactionRepository {
  Future<bool> addTransaction(TransactionModel transactionModel, String userId);
...
class TransactionRepositoryImpl implements TransactionRepository {
  ...
  @override
  Future<bool> addTransaction(TransactionModel transaction, String userId) async {
    try {
